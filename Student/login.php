            ...
            <div class="panel panel-default">
              <div class="panel-body">
                <div class="text-center">
                  <h3><img src="assets/img/logo1.png" alt="Logo" height="100" width="100"></i></h3>
                  ...
                  <div class="panel-body">
                   ...
                   $username1;
                    if(isset($_POST["submit1"])){
                        ...
                        $result = mysqli_query($link,"SELECT* FROM student WHERE email = '$username';");
