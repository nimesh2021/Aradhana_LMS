...
<div class="content" style="left:100px;">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-6">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Add a Advisor</h4>
                            </div>
                            <div class="content">
        ...
        <?php
                   ...
                   if(isset($_POST["submit1"])){
                    ...
                    if (!mysqli_query($link,"INSERT into employee (fname,lname,dob,gender,email,tp,address,nic,password,role) values('$_POST[fname]','$_POST[lname]','$_POST[dob1]','$_POST[gender]','$_POST[email]','$_POST[phone]','$_POST[address1]','$_POST[nic]','$password','Advisor')")){
                        mysqli_error($link);
                    }
