...
$res=mysqli_query($link,"SELECT * FROM employee WHERE aid = '$_SESSION[aid]'");
                    ...
                    <div class="col-md-8">
                        <div class="card">
                            ...
                            <div class="content">
                                <form method="POST" name="form1">
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label>Role</label>
                                                <input type="text" class="form-control" placeholder="Username" name="email"  value=<?php echo $row["role"];?> required disabled>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                ...
                                <a href="reset.php?id=<?php echo $_SESSION['aid'];  ?>"><button class="btn btn-info btn-fill">Reset Password </button> </a>
                                ...
                                <!-- SQL query -->
                                    ...
                                    if(isset($_POST["submit1"])){
                                        ...
                                        if(!mysqli_query($link," UPDATE employee SET fname = '$_POST[fname]', lname = '$_POST[lname]', address = '$_POST[address]', tp = '$_POST[phone]' WHERE aid = $_SESSION[aid]"))
